...
public final class ObserverDescriptor {
	 ...
	 *                                  concrete class with at least one public
	 *                                  constructor or is not assignable to
	 *                                  {@link Runnable}.
	...
	public String toString() {
		return new StringBuffer(getClass().getName().substring(getClass().getName().lastIndexOf('.') + 1)).append('[')
				.append(id).append(';').append(name).append(';').append(type).append(']').toString();
	}
}
