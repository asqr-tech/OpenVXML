...
/**
 * A utility class that provides the quick sort algorithm for classes
...
{
	/**
	 * Returns the quick sorted Comparable array. The compareTo function
	 * of the Comparable interface provides the positional comparisons.
	 *
	...
	/**
	 * Quick sorts the section of the given array specified between the
	 * src index and the end index inclusive. The sorted original array is
	 * then returned for ease-of-use reasons.
	 *
	 * @param  comps The array to sort.
	 * @param  src   The first element of the array section to sort.
	 * @param  end   The last element of the array section to sort.
	 * @return       Comparable[] The original array with the specified
	 *               section sorted.
	 **/
