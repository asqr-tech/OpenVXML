 ...
 * {@link IActionContext} instance available as a scripting object.
 * 
 * <p>
 * This service will make available a "Action" object to all scripts
 * in its scope. The variable supports the following properties:
 * <ul>
 ...
 * 
 * <p>
 * The "Action" scripting object uses the action ID as the implicit
 * value, thus it can be compared to other string objects.
 * </p>
 * 
 * @author Lonnie Pryor
 * @see    IActionContext
...
public class ScriptableActionContext implements IScriptable
{
	 ...
	 * 
	 * @see
	 * org.eclipse.vtp.framework.spi.scripting.IScriptable#clearEntry(
	 * java.lang.String)
	 */
