...
/**
 * This class represents a named set of configuration bindings for
 * attached data submissions. Items and their entries are stored as
 * children to the binding based on the brand, interaction type, and
 * language.
 * 
 * @author trip
 */
public class AttachedDataBinding extends GenericBinding
{
	...
	/**
	 * Creates a new <code>AttachedDataBinding</code> instance with the
	 * given name and managed by the <code>AttachedDataManager</code>
	 * instance provided.
	 * 
	 * @param manager The binding container to manage this binding
	 * @param name    The name of this binding
	 * @see           GenericBinding#GenericBinding(AttachedDataManager,
	 *                String)
	 */
	...
	/**
	 * Locates the <code>AttachedDataBindingItem</code> mapped to the
	 * given brand, interactionType, and language. If there is not an item
	 * already mapped to the provided information a new binding item is
	 * created and returned.
	 * 
	 * @param  brand           The brand the binding item pertains to
	 * @param  interactionType The interaction type the binding item is
	 *                         valid for
	 * @param  language        The language the binding item is associated
	 *                         with
	 * @return                 The binding item registered under the given
	 *                         brand, interaction type, and language, or a
	 *                         new binding item instance if none was
	...
	/**
	 * Registers the binding item instance under the given brand,
	 * interaction type, and language. Any previously mapped binding item
	 * will be replaced and disposed of.
	 * 
	 * @param brand           The brand to map the binding item to
	 * @param interactionType The interaction type to map the binding item
	 *                        to
	 * @param language        The language associated with the binding
	 *                        item
	 * @param item            The binding item to map to the given
	 *                        information.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.vtp.desktop.core.configuration.attacheddata.
	 * GenericBinding#readBindingItem(org.w3c.dom.Element)
	 */
	 ...
	 * 
	 * @see org.eclipse.vtp.desktop.core.configuration.attacheddata.
	 * GenericBinding#writeBindingItem(org.eclipse.vtp.desktop.core.
	 * configuration.attacheddata.GenericBindingItem, org.w3c.dom.Element)
	 */
	public void writeBindingItem(GenericBindingItem item, Element itemConfiguration)
	{
		for (Iterator<AttachedDataItemEntry> i = ((AttachedDataBindingItem) item).getEntries().iterator(); i.hasNext();)
		{
