...
public class DatabaseQueryDataMappingPropertiesPanel extends DesignElementPropertiesPanel implements DatabaseQuerySettingsListener
{
	...
	public void createControls(Composite parent)
	{
		...
		if ((settings.targetVariableName != null) && !settings.targetVariableName.equals("") && (settings.targetVariableType != null)
			&& !settings.targetVariableType.equals(""))
		{
			if (settings.targetVariableExists)
			{
				...
				if (currentObject != null)
				{
					if (currentObject.getType().hasBaseType())
					{
						...
						{
							List<IBusinessObject> businessObjects = businessObjectAspect.getBusinessObjectSet().getBusinessObjects();
			...
			{
				currentObject = VariableHelper.constructVariable(settings.targetVariableName, businessObjectAspect.getBusinessObjectSet(),
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.vtp.desktop.ui.app.editor.model.
	 * DatabaseQuerySettingsListener# targetVariableChanged()
	 */
	public void targetVariableChanged()
	{
		if ((settings.targetVariableName == null) || (settings.targetVariableType == null) || settings.targetVariableName.equals(""))
		{
			currentObject = null;
			mappingTableViewer.refresh();
		...
		if ((currentObject == null)
			|| (!settings.targetVariableName.equals(currentObject.getPath()) || !settings.targetVariableType.equals(currentObject.getType())))
		{
			if (settings.targetVariableExists)
			{
				for (int i = 0; i < incomingVariables.size(); i++)
				{
					...
					else if ((settings.targetVariableName != null) && settings.targetVariableName.startsWith(v.getName()))
					{
	 ...
	 * 
	 * @see org.eclipse.vtp.desktop.ui.app.editor.model.
	 * DatabaseQuerySettingsListener# sourceDatabaseChanged()
	 */
	 ...
	 * 
	 * @see org.eclipse.vtp.desktop.ui.app.editor.model.
	 * DatabaseQuerySettingsListener# dataMappingChanged()
	 */
	 ...
	 * 
	 * @see org.eclipse.vtp.desktop.ui.app.editor.model.
	 * DatabaseQuerySettingsListener# searchCriteriaChanged()
	 */
