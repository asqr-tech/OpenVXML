...
public class DateHelper {
	private static String[] datePatterns = new String[] { "M/d/yyyy", "M-d-yyyy", "M.d.yyyy" };
	private static String[] timePatterns = new String[] { "h:mm:ss a z", "H:mm:ss z", "h:mm:ss a", "H:mm:ss",
			"h:mm a z", "H:mm z", "h:mm a", "H:mm" };
